...
allelic_richness.df <- as.data.frame(allleic_rich$sum.richness)
colnames(allelic_richness.df) <- "Mean allelic richness"

ggplot(data = allelic_richness.df, aes(x = rownames(allelic_richness.df), y = "Mean allelic richness")) + 
