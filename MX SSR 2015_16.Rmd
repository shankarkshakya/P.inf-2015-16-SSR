...
dapc1 <- dapc(P.inf, n.pca = 25, n.da = 5)
dapc1

myCol <- c("darkblue","purple","red","orange", "darkgreen")

scatter.dapc(dapc1, posi.da="topleft", bg="white",
             pch=15:19, cstar=0, col=myCol, 
             scree.pca=F, clabel = TRUE, legend = TRUE,
             posi.pca="bottomleft")


set.seed(999)
P.infx <- xvalDapc(tab(P.inf, NA.method = "mean"), pop(P.inf), 
                   n.pca = 20:30, n.rep = 100, 
                   parallel = "multicore", ncpus = 4L)


scatter(P.infx$DAPC, col=color_pal, clabel = FALSE, scree.pca = TRUE, pch=15:19,
        posi.pca = "bottomleft", posi.leg = "topright", scree.da = FALSE, legend = TRUE, 
        cleg = 1.65, inset.solid = 1, xax = 1, yax = 2, cex.lab = 2, cex = 1.5)

compoplot(P.infx$DAPC, lab ="")
ggcompoplot(P.infx$DAPC, P.inf, pal = color_pal) + 
